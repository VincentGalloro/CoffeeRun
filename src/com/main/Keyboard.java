...
public class Keyboard implements KeyListener{
    ...
    public boolean isKeyDown(Key k){ return keys[k.code]; }
    public boolean isKeyPressed(Key k){ return keysPressed[k.code]; }
    public boolean isKeyReleased(Key k){ return keysReleased[k.code]; }
